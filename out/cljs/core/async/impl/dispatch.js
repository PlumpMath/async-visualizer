...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_10360 = 0;while(true){
var m_10361 = cljs.core.async.impl.dispatch.tasks.pop();if((m_10361 == null))
{} else
{m_10361.call(null);
if((count_10360 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__10362 = (count_10360 + 1);
count_10360 = G__10362;
continue;
}
} else
{}
